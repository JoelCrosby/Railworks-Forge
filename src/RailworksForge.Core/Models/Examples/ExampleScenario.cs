...
public static partial class Example
{
    public static Scenario Scenario = new ()
    {
        ...
        Briefing =
            "An early evening run from Colwich to Crewe with an 8-car Class 325 consist, forming a Willesden to Shieldmuir mail working, diverted today via Stoke due to operational issues. Be aware also of a 60MPH TSR at Hixon.",
